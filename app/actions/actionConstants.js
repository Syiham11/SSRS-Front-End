...
export const ADD_WORKSPACE_CHART = 'ADD_WORKSPACE_CHART';

// Set workspace charts list
export const SET_WORKSPACE_CHARTS = 'SET_WORKSPACE_CHARTS';

// Add chart to dashboard
export const ADD_DASHBOARD_CHART = 'ADD_DASHBOARD_CHART';

// Set dashboard charts list
