...
// import { changeRandomThemeAction } from 'dan-actions/UiActions';
...
class Header extends React.Component {
  ...
  handleTheme = () => {
    const { changeRandomTheme } = this.props;
    changeRandomTheme();
  };
            ...
            <div className={classes.headerProperties}>
              <div className={classNames(classes.headerAction, showTitle && classes.fadeOut)}>
                ...
                <Tooltip title="Change Theme" placement="bottom">
                  <IconButton className={classes.button} onClick={this.handleTheme}>
                    <Ionicon icon="md-color-palette" />
                  </IconButton>
                </Tooltip>
              </div>
...
/* const dispatchToProps = dispatch => ({
  changeRandomTheme: bindActionCreators(changeRandomThemeAction, dispatch),
});
